...
as_draws_df(mdl_durationCat) %>%
  ...
  mutate(
    diff_1_2 = exp(percProm2) - exp(percProm1),
    diff_1_3 = exp(percProm3) - exp(percProm1),
    diff_2_3 = exp(percProm3) - exp(percProm2)
  ) %>%
...
-   **`diff_1_2`:** Estimate = 19.6 [9.36, 29.6], Posterior
...
-   **`diff_1_3`:** Estimate = 46.2 [29.3, 62.9], Posterior
...
-   **`diff_2_3`:** Estimate = 26.6 [12.5, 40.8], Posterior
...
as_draws_df(mdl_f0_slopePostCat) %>%
  ...
  # Compute differences between percProm levels
  mutate(
    diff_1_2 = percProm2 - percProm1,
    diff_1_3 = percProm3 - percProm1,
    diff_2_3 = percProm3 - percProm2
  ) %>%
  # Gather differences into long format
  pivot_longer(
    cols = starts_with("diff_"),
...
-   **`diff_1_2`**: Estimate = 0.058 [0.021, 0.096], Posterior
...
-   **`diff_1_3`**: Estimate = -0.083 [-0.128, -0.036], Posterior
...
-   **`diff_2_3`**: Estimate = -0.141 [-0.186, -0.095], Posterior
...
-   **`diff_1_2`:** Estimate = -0.14 [-0.733, 0.14], Posterior
...
-   **`diff_1_3`:** Estimate = 0.02 [-0.628, 0.666], Posterior
...
-   **`diff_2_3`:** Estimate = 0.16 [-0.138, 0.769], Posterior
...
-   **diff_1_2:** Estimate = -0.055 [-0.595, 0.349], Posterior Probability
...
-   **diff_1_3:** Estimate = 0.062 [-0.555, 0.805], Posterior
...
-   **diff_2_3:** Estimate = 0.117 [-0.314, 0.821], Posterior
...
-   **diff_1_2:** Estimate = -0.136 [-0.734, 0.249], Posterior
...
-   **diff_1_3:** Estimate = 0.035 [-0.627, 0.763], Posterior
...
-   **diff_2_3:** Estimate = 0.171 [-0.232, 0.852], Posterior
...
-   **diff_1_2:** Estimate = 0.015 [-0.423, 0.459], Posterior
...
-   **diff_1_3:** Estimate = 0.049 [-0.427, 0.601], Posterior
...
-   **diff_2_3:** Estimate = 0.034 [-0.416    0.569], Posterior
...
-   **diff_1_2:** Estimate = -0.001 [-0.535, 0.496], Posterior
    Probability = 48.7%; No strong evidence for a difference between
    `percProm1` and `percProm2`.

-   **diff_1_3:** Estimate = 0.004 [-0.571, 0.559], Posterior
    Probability = 51.3%; No conclusive evidence for a difference between
    `percProm1` and `percProm3`.

-   **diff_2_3:** Estimate = 0.005 [-0.497, 0.529], Posterior
...
**percProm1 - percProm0**: The estimated difference in `f0_slope`
...
**percProm2 - percProm0**: The estimated difference between `percProm0`
...
as_draws_df(mdl_f0_slopeGer) %>%
  ...
  # Compute differences between percProm levels
  mutate(
    diff_0_1 = percProm1 - percProm0,
    diff_0_2 = percProm2 - percProm0,
    diff_0_3 = percProm3 - percProm0,
    diff_1_2 = percProm2 - percProm1,
    diff_1_3 = percProm3 - percProm1,
    diff_2_3 = percProm3 - percProm2
  ) %>%
...
-   **`diff_0_1`:** Estimate = 0.056 [-0.045, 0.149], Posterior
...
-   **`diff_0_2`:** Estimate = 0.180 [0.076, 0.278], Posterior
...
-   **`diff_0_3`:** Estimate = 0.244 [0.134, 0.35], Posterior
    Probability = 99.90%; Strong evidence that the `f0_slope` at
    `percProm3` is higher than at `percProm0`.

-   **`diff_1_2`:** Estimate = 0.123 [0.095, 0.152], Posterior
    Probability = 100%; Strong evidence that the `f0_slope` increases
    from `percProm1` to `percProm2`.

-   **`diff_1_3`:** Estimate = 0.188 [0.141, 0.233], Posterior
    Probability = 100%; Strong evidence that the `f0_slope` increases
    from `percProm1` to `percProm3`.

-   **`diff_2_3`:** Estimate = 0.064 [0.024, 0.104], Posterior
...
as_draws_df(mdl_pitch_medianGer) %>%
  ...
  # Compute differences between percProm levels
  mutate(
    diff_0_1 = exp(percProm1) - exp(percProm0),
    diff_0_2 = exp(percProm2) - exp(percProm0),
    diff_0_3 = exp(percProm3) - exp(percProm0),
    diff_1_2 = exp(percProm2) - exp(percProm1),
    diff_1_3 = exp(percProm3) - exp(percProm1),
    diff_2_3 = exp(percProm3) - exp(percProm2)
  ) %>%
...
-   **`diff_0_1`:** Estimate = -9.58 [-41.8, 19.2], Posterior
...
-   **`diff_0_2`:** Estimate = -0.116 [-32.2, 29.0], Posterior
...
-   **`diff_1_3`:** Estimate = 21.3 [13.5, 29.2], Posterior
    Probability = 100%; Strong evidence that the `pitch_median`
    increases from `percProm1` to `percProm3`.

-   **`diff_2_3`:** Estimate = 11.8 [5.75, 18.3], Posterior
    Probability = 100%; Strong evidence that the `pitch_median`
    increases from `percProm2` to `percProm3`.
...
-   **`diff_0_1`:** Estimate = -0.172 [-1.12, 0.342], Posterior
...
-   **`diff_0_2`:** Estimate = -0.082 [-1.06, 0.575], Posterior
...
-   **`diff_0_3`:** Estimate = 0.061 [-0.983, 1.10], Posterior
...
-   **`diff_1_2`:** Estimate = 0.089 [-0.312, 0.597], Posterior
...
-   **`diff_1_3`:** Estimate = 0.233 [-0.299, 1.19], Posterior
...
-   **`diff_2_3`:** Estimate = 0.143 [-0.465, 1.04], Posterior
...
-   **`diff_0_1`:** Estimate = -0.112 [-0.879, 0.36], Posterior
...
-   **`diff_0_2`:** Estimate = -0.026 [-0.822, 0.639], Posterior
...
-   **`diff_0_3`:** Estimate = 0.146 [-0.712, 1.16], Posterior
...
-   **`diff_1_2`:** Estimate = 0.086 [-0.351, 0.67], Posterior
...
-   **`diff_1_3`:** Estimate = 0.258 [-0.287, 1.20], Posterior
...
-   **`diff_2_3`:** Estimate = 0.172 [-0.461, 1.05], Posterior
...
-   **`diff_0_1`:** Estimate = -0.134 [-0.872, 0.269], Posterior
...
-   **`diff_0_2`:** Estimate = -0.021 [-0.784, 0.568], Posterior
...
-   **`diff_0_3`:** Estimate = 0.164 [-0.689, 1.08], Posterior
...
-   **`diff_1_2`:** Estimate = 0.113 [-0.23, 0.6], Posterior
...
-   **`diff_1_3`:** Estimate = 0.298 [-0.177, 1.13], Posterior
...
-   **`diff_2_3`:** Estimate = 0.185 [-0.389, 0.989], Posterior
...
-   **`diff_0_1`:** Estimate = 23.6 [-0.589, 46.0], Posterior
...
-   **`diff_0_2`:** Estimate = 51.4 [26.0, 75.7], Posterior
...
-   **`diff_0_3`:** Estimate = 16.4 [43.2, 107.8], Posterior
    Probability = 100%; Strong evidence that `duration` at `percProm3`
    is higher than at `percProm0`.

-   **`diff_1_2`:** Estimate = 5.28 [17.6, 38.5], Posterior
    Probability = 100%; Strong evidence of an increase in `duration`
    from `percProm1` to `percProm2`.

-   **`diff_1_3`:** Estimate = 10.8 [31.4, 74.1], Posterior
    Probability = 100%; Strong evidence of an increase in `duration`
    from `percProm1` to `percProm3`.

-   **`diff_2_3`:** Estimate = 8.49 [8.22, 41.4], Posterior
...
-   **`diff_0_1`:** Estimate = -0.051 [-1.15, 0.778], Posterior
...
-   **`diff_0_2`:** Estimate = -0.166 [-1.24, 0.446], Posterior
...
-   **`diff_0_3`:** Estimate = -0.205 [-1.27, 0.329], Posterior
...
-   **`diff_1_2`:** Estimate = -0.115 [-0.818, 0.393], Posterior
...
-   **`diff_1_3`:** Estimate = -0.154 [-0.88, 0.315], Posterior
...
-   **`diff_2_3`:** Estimate = -0.039 [-0.506, 0.369], Posterior
...
-   **diff_0_1:** Estimate = `-0.055` [-1.36, 1.09], Posterior
...
-   **diff_0_2:** Estimate = `-0.185` [-1.41, 0.576], Posterior
...
-   **diff_0_3:** Estimate = `-0.13` [-1.39, 0.765], Posterior
...
-   **diff_0_1:** Estimate = `-0.167` [-1.08, 0.333], Posterior
...
-   **diff_1_3:** Estimate = `0.215` [-0.313, 1.11], Posterior
...
-   **diff_2_3:** Estimate = `0.131` [-0.429, 0.977], Posterior
...
-   **diff_0_1:** Estimate = `-0.508` [-19.4, 17.5], Posterior
...
-   **diff_0_2:** Estimate = `13.9` [-4.52, 32.1], Posterior
...
-   **diff_0_3:** Estimate = `13.2` [-6.11, 32.4], Posterior
...
-   **diff_1_2:** Estimate = `14.4` [8.93, 19.8], Posterior
...
-   **diff_1_3:** Estimate = `13.7` [6.34, 21.1], Posterior
...
-   **diff_2_3:** Estimate = `-0.644` [-6.83, 5.83], Posterior
