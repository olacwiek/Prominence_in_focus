...
```{r}
mdl_focus_f0Mean <- brm(F0_mean ~ 1 + Focus + Gender_s + Word_s +
                            (1 + Focus || Language),
                   data = df_prepost_model,
                   prior = priors_f0Mean,
                   family = lognormal(),
                   ...
                   control = list(max_treedepth = 12,
                                  adapt_delta = 0.99),
                   file = paste0(models, "mdl_focus_f0Mean.rds"))

# if we need to compress the model more
#saveRDS(mdl_fullTargetOnly, file = paste0(models, "mdl_fullTargetOnly.rds"), compress = "xz")

mdl_focus_f0Mean <- readRDS(paste0(models, "mdl_focus_f0Mean.rds"))
```
