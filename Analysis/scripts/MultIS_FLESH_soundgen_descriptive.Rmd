---
title: "Acoustic correlates of perceived prominence in German and Catalan: Descriptive statistics and visualizations"
...
```{r avg amplitude_median prom, echo=TRUE, message=FALSE, warning=FALSE}
targets %>% 
  group_by(language, percProm) %>%
...
```{r avg amplitude_median plot, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r avg amplitude_sd prom, echo=TRUE, message=FALSE, warning=FALSE}
targets %>% 
  group_by(language, percProm) %>%
...
```{r avg amplitude_sd plot, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r avg ampl_noSilence_sd prom, echo=TRUE, message=FALSE, warning=FALSE}
targets %>% 
  group_by(language, percProm) %>%
...
```{r avg ampl_noSilence_sd plot, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r avg CPP_median prom, echo=TRUE, message=FALSE, warning=FALSE}
targets %>% 
  group_by(language, percProm) %>%
...
```{r avg CPP_median plot, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r avg CPP_sd prom, echo=TRUE, message=FALSE, warning=FALSE}
targets %>% 
  group_by(language, percProm) %>%
...
```{r avg CPP_sd plot, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r avg flux_median prom, echo=TRUE, message=FALSE, warning=FALSE}
targets %>% 
  group_by(language, percProm) %>%
...
```{r avg flux_median plot, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r avg flux_sd prom, echo=TRUE, message=FALSE, warning=FALSE}
targets %>% 
  group_by(language, percProm) %>%
...
```{r avg flux_sd plot, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r avg novelty_median prom, echo=TRUE, message=FALSE, warning=FALSE}
targets %>% 
  group_by(language, percProm) %>%
...
```{r avg novelty_median plot, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r avg novelty_sd prom, echo=TRUE, message=FALSE, warning=FALSE}
targets %>% 
  group_by(language, percProm) %>%
...
```{r avg novelty_sd plot, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r avg specCentroid_sd prom, echo=TRUE, message=FALSE, warning=FALSE}
targets %>% 
  group_by(language, percProm) %>%
...
```{r avg specCentroid_sd plot, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r avg entropy_sd prom, echo=TRUE, message=FALSE, warning=FALSE}
targets %>% 
  group_by(language, percProm) %>%
...
```{r avg entropy_sd plot, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r avg entropySh_median prom, echo=TRUE, message=FALSE, warning=FALSE}
targets %>% 
  group_by(language, percProm) %>%
...
```{r avg entropySh_median plot, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r avg entropySh_sd prom, echo=TRUE, message=FALSE, warning=FALSE}
targets %>% 
  group_by(language, percProm) %>%
...
```{r avg entropySh_sd plot, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r avg HNR_sd prom, echo=TRUE, message=FALSE, warning=FALSE}
targets %>% 
  group_by(language, percProm) %>%
...
```{r avg HNR_sd plot, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r avg amEnvDep_sd plot, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r avg fmDep_sd plot, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r avg amplitude_median pre, echo=TRUE, message=FALSE, warning=FALSE}
# Values
data_prepost %>% 
  group_by(language, percProm) %>%
...
```{r avg amplitude_sd pre, echo=TRUE, message=FALSE, warning=FALSE}
# Values
data_prepost %>% 
  group_by(language, percProm) %>%
...
```{r avg ampl_noSilence_sd pre, echo=TRUE, message=FALSE, warning=FALSE}
# Values
data_prepost %>% 
  group_by(language, percProm) %>%
...
```{r avg CPP_median pre, echo=TRUE, message=FALSE, warning=FALSE}
# Values
data_prepost %>% 
  group_by(language, percProm) %>%
...
```{r avg CPP_sd pre, echo=TRUE, message=FALSE, warning=FALSE}
# Values
data_prepost %>% 
  group_by(language, percProm) %>%
...
```{r avg flux_median pre, echo=TRUE, message=FALSE, warning=FALSE}
# Values
data_prepost %>% 
  group_by(language, percProm) %>%
...
```{r avg flux_sd pre, echo=TRUE, message=FALSE, warning=FALSE}
# Values
data_prepost %>% 
  group_by(language, percProm) %>%
...
```{r avg novelty_median pre, echo=TRUE, message=FALSE, warning=FALSE}
# Values
data_prepost %>% 
  group_by(language, percProm) %>%
...
```{r avg novelty_sd pre, echo=TRUE, message=FALSE, warning=FALSE}
# Values
data_prepost %>% 
  group_by(language, percProm) %>%
...
```{r avg specCentroid_sd pre, echo=TRUE, message=FALSE, warning=FALSE}
# Values
data_prepost %>% 
  group_by(language, percProm) %>%
...
```{r avg entropy_sd pre, echo=TRUE, message=FALSE, warning=FALSE}
# Values
data_prepost %>% 
  group_by(language, percProm) %>%
...
```{r avg entropySh_median pre, echo=TRUE, message=FALSE, warning=FALSE}
# Values
data_prepost %>% 
  group_by(language, percProm) %>%
...
```{r avg entropySh_sd pre, echo=TRUE, message=FALSE, warning=FALSE}
# Values
data_prepost %>% 
  group_by(language, percProm) %>%
...
```{r avg HNR_sd pre, echo=TRUE, message=FALSE, warning=FALSE}
# Values
data_prepost %>% 
  group_by(language, percProm) %>%
...
```{r avg amEnvDep_sd pre, echo=TRUE, message=FALSE, warning=FALSE}
# Values
data_prepost %>% 
  group_by(language, percProm) %>%
...
```{r avg fmDep_sd pre, echo=TRUE, message=FALSE, warning=FALSE}
# Values
data_prepost %>% 
  group_by(language, percProm) %>%
...
```{r avg amplitude_sd post, echo=TRUE, message=FALSE, warning=FALSE}
# Values
data_prepost %>% 
  group_by(language, percProm) %>%
...
```{r avg ampl_noSilence_sd post, echo=TRUE, message=FALSE, warning=FALSE}
# Values
data_prepost %>% 
  group_by(language, percProm) %>%
...
```{r avg CPP_median post, echo=TRUE, message=FALSE, warning=FALSE}
# Values
data_prepost %>% 
  group_by(language, percProm) %>%
...
```{r avg CPP_sd post, echo=TRUE, message=FALSE, warning=FALSE}
# Values
data_prepost %>% 
  group_by(language, percProm) %>%
...
```{r avg flux_median post, echo=TRUE, message=FALSE, warning=FALSE}
# Values
data_prepost %>% 
  group_by(language, percProm) %>%
...
```{r avg flux_sd post, echo=TRUE, message=FALSE, warning=FALSE}
# Values
data_prepost %>% 
  group_by(language, percProm) %>%
...
```{r avg novelty_median post, echo=TRUE, message=FALSE, warning=FALSE}
# Values
data_prepost %>% 
  group_by(language, percProm) %>%
...
```{r avg novelty_sd post, echo=TRUE, message=FALSE, warning=FALSE}
# Values
data_prepost %>% 
  group_by(language, percProm) %>%
...
```{r avg specCentroid_sd post, echo=TRUE, message=FALSE, warning=FALSE}
# Values
data_prepost %>% 
  group_by(language, percProm) %>%
...
```{r avg entropy_sd post, echo=TRUE, message=FALSE, warning=FALSE}
# Values
data_prepost %>% 
  group_by(language, percProm) %>%
...
```{r avg entropySh_median post, echo=TRUE, message=FALSE, warning=FALSE}
# Values
data_prepost %>% 
  group_by(language, percProm) %>%
...
```{r avg entropySh_sd post, echo=TRUE, message=FALSE, warning=FALSE}
# Values
data_prepost %>% 
  group_by(language, percProm) %>%
...
```{r avg HNR_sd post, echo=TRUE, message=FALSE, warning=FALSE}
# Values
data_prepost %>% 
  group_by(language, percProm) %>%
...
```{r avg amEnvDep_sd post, echo=TRUE, message=FALSE, warning=FALSE}
# Values
data_prepost %>% 
  group_by(language, percProm) %>%
...
```{r avg fmDep_sd post, echo=TRUE, message=FALSE, warning=FALSE}
# Values
data_prepost %>% 
  group_by(language, percProm) %>%
