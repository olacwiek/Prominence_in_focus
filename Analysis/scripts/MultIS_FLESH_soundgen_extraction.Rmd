...
Now we extract summary of features in segments. The window length is set to be 25 at default, but if the file duration is shorter than 50 ms, then window length is set to half of the file duration.
